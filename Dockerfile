...
RUN a2enmod  rewrite
RUN wget https://raw.githubusercontent.com/flowiceeos/youok/main/000-default.conf
RUN rm /etc/apache2/sites-available/000-default.conf
RUN mv 000-default.conf /etc/apache2/sites-available
RUN echo 'You are ok NOW!' >/var/www/html/index.html
...
RUN echo root:dio90quew|chpasswd
